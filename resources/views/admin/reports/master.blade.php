       ...
       <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admin/reports/master-list" class="nav-link active">
                  &nbsp &nbsp &nbsp
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">Master List of Applicants</li>
            </ol>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
     ...
     <div class="content">
      <div class="container-fluid">
        ...
        <div class="card-body"> 
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title"><i class="fa fa-user"></i> MASTER LIST OF APPLICANTS</h1>
                    <hr/>
                    <table class="table">
                        <thead>
                        <tr>
