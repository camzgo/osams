        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/admin/consolidation" class="nav-link active">
                  &nbsp &nbsp &nbsp
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header" id="th-cl1">
              <h3 class="boldtx">Consolidation</h3>
          </div>
          <div class="card-body"> 
         <div class="flt-right">
            ...
            <div class="modal-content">
                <form method="post" id="main_form">
                    <div class="modal-header">
                      <h4 class="modal-title">Consolidation</h4>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="modal-footer">
                          ...
                          <input type="hidden" name="conso" id="conso" value="" />
...
<script>
     $(function() {
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('consolo.getdata') }}',
               columns: [
                        { data: 'fullname', name: 'fullname' },
                        { data: 'school_id', name: 'school_id' },
                        { width: '20%', data: 'barcode_number', name: 'barcode_number' },
    ...
    $('#main_form').on('submit', function(event){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                    ...
                    if($('#button_action').val() == 'Approved')
                    {
                      swal(
                        'Success!',
                        'You have successfully approved an application',
                        'success'
                      )
                    }
                    else if (($('#button_action').val() == 'Disapproved'))
                    {
                      swal(
                        'Success!',
                        'You have successfully disapproved an application',
                        'success'
                      )
                    }
