     ...
     <div class="content">
      <div class="container-fluid">
        ...
        <div class="card-body"> 
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title"><i class="fa fa-check"></i> MESSAGE</h1>
                    <hr/>
                    <p>You have successfully register an applicant. </p>
                    {{-- <br>    --}}
                    <div class="pull-right">
                        <a href="/apply" class="btn btn-success"> Proceed to Apply</a>
                    </div>
                </div>
            </div>
          </div>
