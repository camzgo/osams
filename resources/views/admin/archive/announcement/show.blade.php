          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="/admin/archive/announcement" class="nav-link active">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header" id="th-cl2">
              <h3 class="boldtx">Announcement Archive</h3>
          </div>
          <div class="card-body"> 
         <div class="flt-right">
...
<script>
    ...
    $('#main_form').on('submit', function(event){
        ...
        $.ajax({
            url:"{{ route('archiveannounce.postdata') }}",
            method:"POST",
            data:form_data,
            dataType:"json",
    ...
    $(document).on('click', '.edit', function(){
        ...
        $('#form_output').html('');
        $.ajax({
            url:"{{route('archiveannounce.fetchdata')}}",
            method:'get',
            data:{id:id},
            dataType:'json',
            success:function(data)
...
function confirmDel()
{
    ...
    {
        $.ajax({
            url:"{{route('archiveannounce.removedata')}}",
            method:"get",
            data:{id:id},
            success:function(data)
            {
