            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="/admin/archive/applicant" class="nav-link active">
                          &nbsp &nbsp &nbsp &nbsp &nbsp
                        <i class="fa fa-user nav-icon"></i>
                        <p>Applicant</p>
                        </a>
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header" id="th-cl2">
              <h3 class="boldtx">Applicant Archive</h3>
          </div>
          <div class="card-body"> 
         <div class="flt-right">
...
<script>
    ...
    $('#main_form').on('submit', function(event){
        ...
        $.ajax({
            url:"{{ route('archiveapplicant.postdata') }}",
            method:"POST",
            data:form_data,
            dataType:"json",
    ...
    $(document).on('click', '.edit', function(){
        ...
        $('#form_output').html('');
        $.ajax({
            url:"{{route('archiveapplicant.fetchdata')}}",
            method:'get',
            data:{id:id},
            dataType:'json',
            success:function(data)
...
function confirmDel()
{
    ...
    if(confirm=='true')
    {
        ...
        $.ajax({
            url:"{{route('archiveapplicant.removedata')}}",
            method:"get",
            data:{id:id},
            success:function(data)
            { 
