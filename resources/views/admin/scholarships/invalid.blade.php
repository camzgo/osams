     ...
     <div class="content">
      <div class="container-fluid">
        ...
        <div class="card-body"> 
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title"><i class="fa fa-warning"></i> MESSAGE</h1>
                    <hr/>
                    <p><strong> This applicant is not allowed</strong> to apply for this scholarship category or any of these categories because he/she is an SPES recipient.</p>
                    {{-- <br>    --}}
