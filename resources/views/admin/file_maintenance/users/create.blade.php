      ...
      <div class="container-fluid">
        <div class="card">
          ...
          {{-- <form class="needs-validation" novalidate>
            ...
            {{-- {!! Form::open(['action' => 'UsersMainController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            {{csrf_field()}}
            <div class="container">
              ...
              <div class="row form-group">
                ...
                <div class = "col-md-2">
                    {{Form::text('suffix', '', ['class' => 'form-control', 'placeholder' => 'Suffix (Jr. Sr. III)'])}}
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-2">
                    {{Form::label('gender', '* Gender')}}
                    {{Form::select('size', array('M' => 'Male', 'F' => 'Female'), NULL, array('class' => 'form-control', 'placeholder' =>'--Select--'))}}
                </div>
                <div class="col-md-2">
                    {{Form::label('bday', '* Birthdate')}}
                    {{Form::date('bday', new \DateTime(), ['class' => 'form-control', 'required'])}}
                </div>
                <div class="col-md-3">
                    {{Form::label('surname', '* Nationality')}}
                    {{Form::text('suffix', '', ['class' => 'form-control', 'placeholder' => '--Select--', 'required'])}}
                </div>
                <div class="col-md-3">
                    {{Form::label('surname', 'Religion')}}
                    {{Form::text('suffix', '', ['class' => 'form-control', 'placeholder' => '--Select--', 'required'])}}
                </div>
                <div class="col-md-2">
                    {{Form::label('gender', '* Civil Status')}}
                    {{Form::select('size', array('S' => 'Single', 'M' => 'Married', 'W' => 'Widowed'), NULL, array('class' => 'form-control', 'placeholder' =>'--Select--', 'required'))}}
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-3">
                    {{Form::label('gender', '* Municipality')}}
                    {{Form::select('size', array('S' => 'Single', 'M' => 'Married', 'W' => 'Widowed'), NULL, array('class' => 'form-control', 'placeholder' =>'--Select--', 'required'))}}
                </div>
                <div class="col-md-3">
                    {{Form::label('gender', '* Barangay')}}
                    {{Form::select('size', array('S' => 'Single', 'M' => 'Married', 'W' => 'Widowed'), NULL, array('class' => 'form-control', 'placeholder' =>'--Select--', 'required'))}}
                </div>
                <div class="col-md-6">
                    {{Form::label('surname', '* Street')}}
                    {{Form::text('suffix', '', ['class' => 'form-control', 'placeholder' => 'Street', 'required'])}}
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-4">
                    {{Form::label('surname', '* Mobile Number')}}
                    {{Form::text('mobile', '', ['class' => 'form-control', 'placeholder' => '09xx-xxx-xxxx', 'required'])}}
                </div>
                <div class="col-md-4">
