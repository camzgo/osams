      ...
      <div class="tab">
        ...
        <div class="row form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control req" id="gmobile_no" value="{{$eefap->gmobile_number}}" name="gmobile_no" placeholder='9xxxxxxxxx' required/>
            </div>
        </div>
        </div>
      </div>
      ...
      <div class="tab">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-5">
                ...
                <input name="college_address" type="text" class="form-control req" value="{{$eefap->college_address}}" placeholder ="(Building no., Street, City Municipality, Province)">
            </div>
            <div class="col-md-2">
                <label>* Year Level</label>
                <div class="input-group">
                  <input name="yr_lvl" type="text" class="form-control req" value="{{$eefap->year_level}}" placeholder ="1st">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-3">
                ...
                <input name="major" name="major" type="text" class="form-control req" value="{{$eefap->major}}" placeholder ="Major">
            </div>
            <div class="col-md-2">
                <label>* General Average</label>
                <input name="gen_average" id="gen_average" type="text" class="form-control req" value="{{$eefap->general_average}}" placeholder ="1.25">
            </div>
            <div class="col-md-3">
