...
class CreateTableReqgv extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reqgv', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('honor_sub', 20)->default('Not Submitted');
